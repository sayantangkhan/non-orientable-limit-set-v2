...
Their methods are stronger than the ones in this paper, because we study the dynamics of foliations by studying the dynamics of the first return map on a transverse interval.
While this reduction makes the analysis significantly simpler, and works for most foliations, it does not work for all foliations.
...
The authors of the other paper get around this limitation by directly analyzing the train tracks associate to the foliation, which fully captures their dynamics.
...
\begin{proof}
  ...
  \begin{proof}
    ...
    \autoref{fig:q1q2} shows the two arcs on $\mathcal{P}$ and \autoref{fig:q1toq2} shows the homotopy on the quotient that takes $\widetilde{q_2}$ to $\widetilde{q_1}$.
    \begin{figure}[h]
      \centering
