...
In the case of infinite volume geometrically finite manifolds, the wandering set in the boundary is a large open set contained in the complement of the limit set.
In the setting of $\teich(\no_g)$, even though the limit set is contained in the complement of a large open set, we show that the wandering set is empty.
\begingroup
