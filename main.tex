...
\item[] $\ell_{\mathrm{hyp}}(M, \gamma)$: The hyperbolic length of $\gamma$ with respect to the hyperbolic structure on $M \in \teich(S)$.
\item[] $\ell_{\mathrm{flat}}(q, \gamma)$: The flat length of $\gamma$ with respect to the flat structure given by the DQD $q$.
