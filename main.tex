...
\end{definition}
In the setting of orientable surfaces, the vertical foliations of translation surfaces are orientable, while there are some directions in half-translation surfaces (which are not translation surfaces) where the foliation is non-orientable.
...
\begin{proof}[Proof of \autoref{thm:rational-approximation}]
  ...
  Furthermore, the geodesic tightening of the resulting curve is very close to the original curve, because the initial and final tangent vectors can be made arbitrarily close since they both face the ``up'' direction: the Anosov closing lemma then tells us that an orbit that approximately closes up can be perturbed by a small amount to exactly close up.
...
This quantitative estimate gives us an easy proof of \autoref{thm:systole-closure}.
