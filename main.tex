...
\begin{proof}
  ...
  \begin{proof}
    ...
    Since $p_0$ was one-sided, $\widetilde{q_i}$ intersect $\widetilde{p_0}$ at two points, which are diametrically opposite.
    ...
    \autoref{fig:q1q2} shows the two arcs on $\mathcal{P}$ and \autoref{fig:q1toq2} shows that homotopy on the quotient that takes $\widetilde{q_2}$ to $\widetilde{q_1}$.
    \begin{figure}[h]
      \centering
  ...
  \begin{proof}
    ...
    We construct $q$ by starting along $p_0$, at the point where $p_4$ intersects $p_0$, and then follow along $p_4$.
