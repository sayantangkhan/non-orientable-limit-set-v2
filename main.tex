...
\begin{proof}
  ...
  Since $\nu$ is the vertex of a finite-dimensional convex set, any weighted average of the $\iota_{ij}$ must be at least distance $\frac{\varepsilon - \frac{\varepsilon}{k}}{k^{\prime}}$ from $\nu$, where the multiplicative factor $k^{\prime}$ only depends on the geometry of the convex set of invariant probability measures, and not $\varepsilon$ or $k$.
