...
\begin{proof}
  ...
  Using the fact that $\gamma_1$ and $\gamma_2$ have intersection number $1$ with Liouville current, we get the following inequality for a large enough $j$ for some $k$.
  \begin{align}
    \label{eq:9}
