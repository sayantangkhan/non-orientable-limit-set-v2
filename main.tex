...
\begin{remark}
  The specific family of subgroups considered by McCarthy-Papadopoulos were subgroups containing at least two non-commuting pseudo-Anosov mapping classes.
  In this case, the dynamical limit set is unique and also the same equal to the closure of the uniquely ergodic foliations that are the stable and unstable foliations of the pseudo-Anosov elements of the subgroup.
